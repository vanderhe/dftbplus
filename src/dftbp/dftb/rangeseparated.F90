...
#:if WITH_SCALAPACK
  ...
  use dftbp_extlibs_scalapackfx, only : CSRC_, DLEN_, MB_, NB_, RSRC_, pblasfx_pgemm,&
      ...
      & scalafx_getdescriptor, scalafx_getlocalshape, scalafx_addg2l, scalafx_addl2g
...
#:if WITH_SCALAPACK
    ...
    do iAt1 = 1, nAtom0
      ...
      do iAt2 = 1, nAtom0
        ...
        do iKS = 1, parallelKS%nLocalKS
          ...
          call scalafx_addg2l(env%blacs%orbitalGrid, denseDesc%blacsOrbSqr, iOrbStart2, iOrbStart1,&
              & global(:,:, iKS), local(iOrbStart2:iOrbEnd2, iOrbStart1:iOrbEnd1, iSpin))
        end do
      end do
    end do
  ...
  subroutine scatterFullToDistributed(env, denseDesc, parallelKS, species0, local, global)
    ...
    !! Auxiliary variables
    integer :: iAt1, iAt2, iOrbStart1, iOrbStart2, iOrbEnd1, iOrbEnd2
    ...
    do iAt1 = 1, nAtom0
      ...
      do iAt2 = 1, nAtom0
        ...
        do iKS = 1, parallelKS%nLocalKS
          iSpin = parallelKS%localKS(2, iKS)
          call scalafx_addl2g(env%blacs%orbitalGrid, local(iOrbStart2:iOrbEnd2,&
              & iOrbStart1:iOrbEnd1, iSpin), denseDesc%blacsOrbSqr, iOrbStart2, iOrbStart1,&
              & global(:,:, iKS))
        end do
      end do
    end do
